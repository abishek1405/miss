"""
Django settings for Multiple_authentications project.
...
ROOT_URLCONF = 'Multiple_authentications.urls'
...
WSGI_APPLICATION = 'Multiple_authentications.wsgi.application'
